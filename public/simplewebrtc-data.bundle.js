...
SimpleWebRTCData.prototype.handlePeerStreamAdded = function (peer) {
...
SimpleWebRTCData.prototype.handlePeerStreamRemoved = function (peer) {
    var container = this.getRemoteVideoContainer();
...
SimpleWebRTCData.prototype.setVolumeForAll = function (volume) {
    this.webrtc.peers.forEach(function (peer) {
...
SimpleWebRTCData.prototype.shareScreen = function (cb) {
    var self = this,
        peer;
...
},{"mockconsole":2,"webrtc-data":3,"webrtcsupport":6,"wildemitter":7}],2:[function(require,module,exports){
...
},{"./webrtc-peer":4,"mockconsole":2,"webrtcsupport":6,"wildemitter":7}],4:[function(require,module,exports){
...
module.exports = Peer;
},{"rtcpeerconnection":5,"wildemitter":7}],5:[function(require,module,exports){
var WildEmitter = require('wildemitter');
var webrtc = require('webrtcsupport');
...
},{"webrtcsupport":6,"wildemitter":7}],6:[function(require,module,exports){
